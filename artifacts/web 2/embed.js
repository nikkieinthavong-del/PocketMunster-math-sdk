...
}function maybeAuto(){if(document.getElementById('stage'))init();}window.PocketMunsters={init,Animator,sfx,version:'1758853957'};if(document.readyState!=='loading')maybeAuto();else document.addEventListener('DOMContentLoaded',maybeAuto,{once:true});})();