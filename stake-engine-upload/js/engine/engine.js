...
export function spin(configJson, bet, opts = {}) {
    ...
    const multiplierMap = opts.initMultiplierMap ??
    ...
    const grid = Array.from({ length: rows }, () => Array.from({ length: cols }, () => ({ kind: 'blank' })));
