/**
 * PocketMon Genesis Reels - Stake Engine Frontend
 * Main entry point for the game frontend
 */
...
class PocketMonGame {
  ...
  private elements: {
    ...
    winDisplay?: HTMLElement
    loadingScreen?: HTMLElement
  }
  private logoSystem: LogoSystem | null = null
  ...
  private createUI() {
      ...
      <div class="game-container">
        ...
        <div class="game-header">
          <div class="game-title">🔥 PocketMon Genesis Reels</div>
            <img src="images/logo.png" alt="Game Logo" class="game-logo" id="game-logo" />
        ...
        <div id="win-display" class="win-display" style="display: none;">
          ...
          <div>You won: $<span id="win-amount">0.00</span></div>
            <img src="images/logo.png" alt="Game Logo" class="win-logo" id="win-logo" />
        </div>
      </div>
    `
    ...
    // Initialize LogoSystem and set default logo
  this.logoSystem = new LogoSystem()
  // Default public path for Vite served assets (served from /public)
      this.logoSystem.setLogo('images/logo.png')
  }
  ...
  private showWin(amount: number) {
    ...
    // Ensure win logo visible
    this.logoSystem?.showWin(true)
  }
