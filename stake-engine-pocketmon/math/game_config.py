"""PocketMon Genesis Reels game configuration file with complete 151 Gen 1 PocketMon."""

# Simplified standalone configuration for testing


class GameConfig:
    """PocketMon Genesis Reels configuration class with all 151 Gen 1 PocketMon."""
    ...
    def __init__(self):
        ...
        self.wild_symbol = "ditto"               # Ditto acts as wild substitute
        self.scatter_symbol = "pokeball"         # Pokeballs trigger free spins
        self.multiplier_symbol = "masterball"    # Master Balls enhance wins
        
        # Free spin configuration
        self.freespin_triggers = {3: 10, 4: 15, 5: 20}  # Pokeballs -> free spins
        self.retrigger_spins = {3: 5, 4: 10, 5: 15}     # Additional spins on retrigger
        
        # Betting configuration
        self.bets = [0.20, 0.40, 1.00, 2.00, 4.00, 10.00, 20.00, 50.00, 100.00]
        self.bet_modes = [
            {"name": "base", "cost": 1.00, "description": "Base game", "is_feature": False, "is_buybonus": False}
        ]
        
        # Game mode configuration
        self.basegame_type = "base"
        self.freegame_type = "freespin"
        
        # Initialize reel strips and distributions
        self.setup_reel_strips()
        self.setup_distributions()
    
    def setup_reel_strips(self):
        """Configure reel strips with balanced symbol distribution"""
        # Base game reels - balanced distribution across all tiers
        self.base_reels = {
            0: [  # Reel 1 - More basic symbols
                "rattata", "caterpie", "weedle", "pidgey", "spearow", "ekans",
                "pikachu", "sandshrew", "nidoran_f", "nidoran_m", "clefairy",
                ...
                "gastly", "drowzee", "krabby", "voltorb", "exeggcute", "cubone",
                "koffing", "rhyhorn", "horsea", "goldeen", "staryu", "magikarp",
                "bulbasaur", "charmander", "squirtle", "eevee", "omanyte", "kabuto", "dratini"
            ],
            1: [  # Reel 2 - Mixed distribution  
                "rattata", "spearow", "pidgey", "caterpie", "weedle", "ekans",
                "pikachu", "sandshrew", "nidoran_f", "nidoran_m", "clefairy",
                "vulpix", "jigglypuff", "zubat", "oddish", "paras", "venonat",
                "metapod", "kakuna", "pidgeotto", "nidorina", "nidorino", "ivysaur",
                "charmeleon", "wartortle", "golbat", "gloom", "poliwhirl", "kadabra",
                "machoke", "weepinbell", "graveler", "magneton", "haunter", "rhydon",
                "seadra", "dragonair", "venusaur", "charizard", "blastoise", "butterfree",
                "beedrill", "pidgeot", "raichu", "pokeball", "ditto", "farfetchd"
            ],
            2: [  # Reel 3 - Center reel with good symbol mix
                "pikachu", "eevee", "bulbasaur", "charmander", "squirtle", "pidgey",
                "clefairy", "vulpix", "jigglypuff", "meowth", "psyduck", "growlithe",
                "abra", "ponyta", "slowpoke", "gastly", "cubone", "dratini",
                "ivysaur", "charmeleon", "wartortle", "pidgeotto", "kadabra", "machoke",
                "haunter", "dragonair", "venusaur", "charizard", "blastoise", "raichu",
                "nidoqueen", "nidoking", "arcanine", "alakazam", "machamp", "gengar",
                "vaporeon", "jolteon", "flareon", "dragonite", "gyarados", "ditto",
                "pokeball", "masterball", "snorlax", "lapras", "aerodactyl"
            ],
            3: [  # Reel 4 - Mixed with evolution symbols
                "rattata", "pidgey", "spearow", "ekans", "sandshrew", "zubat",
                "oddish", "paras", "venonat", "diglett", "mankey", "poliwag",
                "machop", "bellsprout", "tentacool", "geodude", "magnemite", "doduo",
                "seel", "grimer", "shellder", "drowzee", "krabby", "voltorb",
                "pidgeotto", "golbat", "gloom", "poliwhirl", "weepinbell", "graveler",
                "magneton", "rhydon", "seadra", "raticate", "fearow", "arbok",
                "sandslash", "clefable", "ninetales", "wigglytuff", "vileplume",
                "parasect", "venomoth", "dugtrio", "persian", "golduck", "primeape",
                "pokeball", "ditto"
            ],
            4: [  # Reel 5 - Higher value symbols more frequent
                "pikachu", "eevee", "bulbasaur", "charmander", "squirtle", "gastly",
                "cubone", "dratini", "ivysaur", "charmeleon", "wartortle", "kadabra",
                "machoke", "haunter", "dragonair", "venusaur", "charizard", "blastoise",
                "butterfree", "beedrill", "pidgeot", "raichu", "nidoqueen", "nidoking",
                "arcanine", "alakazam", "machamp", "gengar", "vaporeon", "jolteon",
                "flareon", "gyarados", "dragonite", "poliwrath", "victreebel", "tentacruel",
                "golem", "rapidash", "slowbro", "dodrio", "dewgong", "muk", "cloyster",
                "hypno", "kingler", "electrode", "exeggutor", "marowak", "weezing",
                "pokeball", "masterball", "ditto"
            ]
        }
        
        # Free spin reels - enhanced with more high-value symbols
        self.freespin_reels = {
            0: [  # Enhanced reel 1
                "pikachu", "eevee", "bulbasaur", "charmander", "squirtle", "gastly",
                "ivysaur", "charmeleon", "wartortle", "kadabra", "machoke", "haunter",
                "venusaur", "charizard", "blastoise", "raichu", "alakazam", "machamp",
                "gengar", "vaporeon", "jolteon", "flareon", "gyarados", "dragonite",
                "ditto", "pokeball", "snorlax", "lapras", "aerodactyl", "mew"
            ],
            1: [  # Enhanced reel 2
                "pidgeotto", "kadabra", "machoke", "haunter", "dragonair", "venusaur",
                "charizard", "blastoise", "butterfree", "beedrill", "pidgeot", "raichu",
                "nidoqueen", "nidoking", "arcanine", "alakazam", "machamp", "gengar",
                "vaporeon", "jolteon", "flareon", "gyarados", "dragonite", "ditto",
                "pokeball", "snorlax", "lapras", "aerodactyl", "farfetchd", "onix"
            ],
            2: [  # Enhanced center reel
                "venusaur", "charizard", "blastoise", "raichu", "alakazam", "machamp",
                "gengar", "vaporeon", "jolteon", "flareon", "gyarados", "dragonite",
                "snorlax", "lapras", "aerodactyl", "ditto", "pokeball", "masterball",
                "mew", "articuno", "zapdos", "moltres", "mewtwo", "hitmonlee", "hitmonchan"
            ],
            3: [  # Enhanced reel 4
                "butterfree", "beedrill", "pidgeot", "raticate", "fearow", "arbok",
                "sandslash", "clefable", "ninetales", "wigglytuff", "vileplume",
                "parasect", "venomoth", "dugtrio", "persian", "golduck", "primeape",
                "poliwrath", "victreebel", "tentacruel", "golem", "rapidash", "slowbro",
                "dodrio", "dewgong", "muk", "cloyster", "hypno", "kingler", "electrode",
                "pokeball", "ditto", "snorlax", "lapras"
            ],
            4: [  # Enhanced reel 5
                "gyarados", "dragonite", "vaporeon", "jolteon", "flareon", "venusaur",
                "charizard", "blastoise", "alakazam", "machamp", "gengar", "raichu",
                "snorlax", "lapras", "aerodactyl", "ditto", "pokeball", "masterball",
                "mew", "articuno", "zapdos", "moltres", "mewtwo", "exeggutor", "marowak",
                "seaking", "starmie", "omastar", "kabutops", "mr_mime", "scyther"
            ]
        }
    
    def setup_distributions(self):
        """Setup symbol distributions for simulation"""
        self.distributions = {
            "base": self.base_reels,
            "freespin": self.freespin_reels
        }
